...
namespace FASTECH
{
	partial class EziMOTIONPlusELib
	{
        ...
        /* 나는 TCP IP 프로토콜을 쓸거기 때문에
		 sb1: 192, sb2: 168, sb3: 0, sb4: 20 -> 파스텍 EZI DIO 260124 박천의 주석
		아래 펑션을 사용할 것이다.
		*/
		...
		public static int FAS_GetSlaveInfo(int iBdID, ref byte pType, StringBuilder ipBuff, ref string version)
		{
			int nRtn = FMM_OK;
			byte type = 0;
